...
import org.hucompute.uimadockerwrapper.util.AnnotatorParameterWrapper;
...
public class DockerWrapperTest {
    ...
    @Test
    void third_test() throws UIMAException, IOException, SAXException, CompressorException {
