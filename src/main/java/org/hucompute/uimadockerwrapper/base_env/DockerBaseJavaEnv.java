...
public class DockerBaseJavaEnv extends DockerBaseEnvImpl {
    public DockerBaseJavaEnv() {
        ...
        add_raw_dockercmd("ADD https://kava-i.de/download/framework2.tar.bz2 /base.tar.bz2");
    ...
    public void enable_python() {
        ...
        add_raw_dockercmd("RUN DEBIAN_FRONTEND=noninteractive apt install -y python pip --fix-missing");
        add_raw_dockercmd("RUN apt install -y openjdk-11-jdk --fix-missing");
